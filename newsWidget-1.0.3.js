class NewsWidget extends HTMLElement {
  ...
  renderNewsCard(entity, baseUrl) {
    ...
    // Formatage de la date à supprimer
    let dateToRemove = new Date(entity.publish_at).toLocaleDateString(); 
    // Remplacement de la date par une chaîne vide dans le titre
    let cleanedTitle = title.replace(dateToRemove, '').trim(); 
            ...
            <a class="link" href="${baseUrl}/app/nos-actualites/${entity.id}/${this.slugify(entity.title)}">
                <div class="public-card">
                    ...
                    <section class="public-card__body">
                        <p class="public-card__title">${cleanedTitle}</p>
